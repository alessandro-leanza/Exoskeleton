...
Once calibration is complete, the codes to run are 1) 'ros2 run exo_control twoboards_odrive' 2) 'ros2 run exo_control admittancecontrol_box' 3) 'ros2 run exo_control stoop_trajs' (even if it does nothing for now) 4) 'cd exo_control/exo_control' 'python tobii.py'
